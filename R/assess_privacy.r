...
#' @param facet.field default is \code{"SPECCD_ID"}.  In cases like bycatch data, you may have a dataframe
...
#' @param key.fields default is \code{c("TRIP","SET_NO")}.  This is a vector of fields that are required
